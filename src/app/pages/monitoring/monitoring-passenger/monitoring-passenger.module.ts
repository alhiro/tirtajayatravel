...
import { MonitoringPassengerRoutingModule } from './monitoring-passenger-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    NgbTooltipModule,
    // Lazy loading
    MonitoringPassengerRoutingModule,
    // Custom modules
    SharedModule,
    DropdownMenusModule,
    TableModule,
...
export class MonitoringPassengerModule {}
